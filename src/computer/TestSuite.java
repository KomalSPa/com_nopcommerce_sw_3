...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Komal S");//firstname
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Prime");//lastname
        sendTextToElement(By.id("BillingNewAddress_Email"),"prime123@gmail.com");//email
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Komal S Prime");
        sendTextToElement(By.xpath("//input[@id='CardNumber']"), "5533 1122 5588 7799 0000");
